...
```text
GET https://api-keymanager.ngsc.go.kr/keymanager/v1.0/appkey/{appkey}/confirm
```
[Response Body]
...
```text
GET https://api-keymanager.ngsc.go.kr/keymanager/v1.0/appkey/{appkey}/secrets/{keyid}
```
...
```text
POST https://api-keymanager.ngsc.go.kr/keymanager/v1.0/appkey/{appkey}/symmetric-keys/{keyid}/encrypt
```
...
```text
POST https://api-keymanager.ngsc.go.kr/keymanager/v1.0/appkey/{appkey}/symmetric-keys/{keyid}/decrypt
```
...
```text
POST https://api-keymanager.ngsc.go.kr/keymanager/v1.0/appkey/{appkey}/symmetric-keys/{keyid}/create-local-key
```
...
#### v1.0
```text
GET https://api-keymanager.ngsc.go.kr/keymanager/v1.0/appkey/{appkey}/symmetric-keys/{keyid}/symmetric-key
```
...
#### v1.1
```text
GET https://api-keymanager.ngsc.go.kr/keymanager/v1.1/appkey/{appkey}/symmetric-keys/{keyid}/symmetric-key?keyVersion={keyVersion}
```
...
```text
POST https://api-keymanager.ngsc.go.kr/keymanager/v1.0/appkey/{appkey}/asymmetric-keys/{keyid}/sign
```
...
```text
POST https://api-keymanager.ngsc.go.kr/keymanager/v1.0/appkey/{appkey}/asymmetric-keys/{keyid}/verify
```
...
```text
GET https://api-keymanager.ngsc.go.kr/keymanager/v1.0/appkey/{appkey}/asymmetric-keys/{keyid}/privateKey?keyVersion={keyVersion}
```
...
```text
GET https://api-keymanager.ngsc.go.kr/keymanager/v1.0/appkey/{appkey}/asymmetric-keys/{keyid}/publicKey?keyVersion={keyVersion}
```
