...
| com.nhncloud.android:nhncloud-iap-onestore2:1.13.0 | In-app Purchase <br>ONE store(통합 버전) |
...
## NHN Cloud SDK를 Android Studio 프로젝트에 적용 { #apply-nhn-cloud-sdk-to-android-studio-projects }

<a id="build-android-with-gradle"></a>
### 1. Gradle을 사용하여 Android 빌드 { #build-android-with-gradle }
...
### UserID 설정 API 명세 { #specification-for-user-id-setting-api }
...
### UserID 설정 예 { #example-of-user-id-setting }
...
### 디버그 모드 설정 API 명세 { #specification-for-debug-mode-setting-api }
...
## NHN Cloud 서비스 사용 { #use-nhn-cloud-services }
