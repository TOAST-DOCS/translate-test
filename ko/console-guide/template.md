...
* 발신 프로필을 선택하고 템플릿을 등록합니다.
* 템플릿 코드는 사용자가 직접 등록하는 방식이 아닌, 카카오에서 랜덤한 식별자를 부여합니다.
* 메시지 타입을 선택하고 내용을 작성합니다.
    * 지원하는 메시지 타입: 텍스트, 이미지, 와이드 이미지, 와이드 아이템 리스트, 캐러셀 피드, 프리미엄 동영상, 커머스, 캐러셀 커머스
* 버튼을 등록할 수 있습니다.
    * 지원하는 버튼 유형: 웹 링크, 앱 링크, 봇 키워드, 메시지 전달, 상담톡 전환, 봇 전환, 비즈니스폼, 채널 추가
* 쿠폰을 등록할 수 있습니다.
