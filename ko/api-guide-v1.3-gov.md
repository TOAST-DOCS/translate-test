## Security > Secure Key Manager > API v1.3 가이드
...
각 인증 방법의 확인 및 사용에 대한 자세한 내용은 각각 [Appkey](/nhncloud/ko/public-api/appkey-gov), [프로젝트 통합 Appkey](/nhncloud/ko/public-api/project-integrated-appkey-gov), [User Access Key 토큰](/nhncloud/ko/public-api/user-access-key-token-gov)를 참고하세요.

### API 목록

| Method | URI                                                                                          | 설명                                                                                        |
| ------ | -------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------- |
| GET    | /keymanager/v1.3/appkey/{appkey}/confirm                                                     | API를 호출한 클라이언트 정보를 제공합니다.                                                  |
| GET    | /keymanager/v1.3/appkey/{appkey}/secrets/{keyid}                                             | Secure Key Manager에 저장한 기밀 데이터를 조회합니다.                                       |
| PUT    | /keymanager/v1.3/appkey/{appkey}/secrets/{keyid}                                             | Secure Key Manager에 저장한 기밀 데이터를 수정합니다.                                       |
| POST   | /keymanager/v1.3/appkey/{appkey}/symmetric-keys/{keyid}/encrypt                              | Secure Key Manager에 저장한 대칭 키로 데이터를 암호화합니다.                                |
| POST   | /keymanager/v1.3/appkey/{appkey}/symmetric-keys/{keyid}/decrypt                              | Secure Key Manager에 저장한 대칭 키로 데이터를 복호화합니다.                                |
| POST   | /keymanager/v1.3/appkey/{appkey}/symmetric-keys/{keyid}/create-local-key                     | 클라이언트가 로컬 환경에서 데이터 암/복호화에 사용할 수 있는 ARIA-256 대칭 키를 생성합니다. |
...
| PUT    | /keymanager/v1.3/appkey/{appkey}/keys/{keyid}/delete                                         | Secure Key Manager에 저장한 키의 삭제를 요청합니다.                                         |
| DELETE | /keymanager/v1.3/appkey/{appkey}/keys/{keyid}                                                | Secure Key Manager에 삭제 예정인 키를 즉시 삭제합니다.                                      |
...
| GET    | /keymanager/v1.3/appkey/{appkey}/keystores/{keyStoreId}/keys/{keyId}                         | Secure Key Manager에 저장된 키 저장소의 키를 상세 조회합니다.                               |
| GET    | /keymanager/v1.3/appkey/{appkey}/keystores/{keyStoreId}/ips                                  | Secure Key Manager에 저장된 키 저장소의 IPv4 인증 정보들을 조회합니다.                      |
| GET    | /keymanager/v1.3/appkey/{appkey}/keystores/{keyStoreId}/ips?value={ipv4Value}                | Secure Key Manager에 저장된 키 저장소의 IPv4 인증 정보를 상세 조회합니다.                   |
| GET    | /keymanager/v1.3/appkey/{appkey}/keystores/{keyStoreId}/macs                                 | Secure Key Manager에 저장된 키 저장소의 MAC 인증 정보들을 조회합니다.                       |
| GET    | /keymanager/v1.3/appkey/{appkey}/keystores/{keyStoreId}/macs?value={macValue}                | Secure Key Manager에 저장된 키 저장소의 MAC 인증 정보를 상세 조회합니다.                    |
| GET    | /keymanager/v1.3/appkey/{appkey}/keystores/{keyStoreId}/certificates                         | Secure Key Manager에 저장된 키 저장소의 인증서 인증 정보들을 조회합니다.                    |
| GET    | /keymanager/v1.3/appkey/{appkey}/keystores/{keyStoreId}/certificates?value={certificateName} | Secure Key Manager에 저장된 키 저장소의 인증서 인증 정보를 상세 조회합니다.                 |
...
```text
GET https://api-keymanager.gov-nhncloudservice.com/keymanager/v1.3/appkey/{appkey}/confirm
```
...
```text
GET https://api-keymanager.gov-nhncloudservice.com/keymanager/v1.3/appkey/{appkey}/secrets/{keyid}
```
...
```text
PUT https://api-keymanager.gov-nhncloudservice.com/keymanager/v1.3/appkey/{appkey}/secrets/{keyid}
```
...
```text
POST https://api-keymanager.gov-nhncloudservice.com/keymanager/v1.3/appkey/{appkey}/symmetric-keys/{keyid}/encrypt
```
...
```text
POST https://api-keymanager.gov-nhncloudservice.com/keymanager/v1.3/appkey/{appkey}/symmetric-keys/{keyid}/decrypt
```
...
```text
POST https://api-keymanager.gov-nhncloudservice.com/keymanager/v1.3/appkey/{appkey}/symmetric-keys/{keyid}/create-local-key
```
...
```text
GET https://api-keymanager.gov-nhncloudservice.com/keymanager/v1.3/appkey/{appkey}/symmetric-keys/{keyid}/symmetric-key?keyVersion={keyVersion}
```
...
```text
POST https://api-keymanager.gov-nhncloudservice.com/keymanager/v1.3/appkey/{appkey}/asymmetric-keys/{keyid}/sign
```
...
```text
POST https://api-keymanager.gov-nhncloudservice.com/keymanager/v1.3/appkey/{appkey}/asymmetric-keys/{keyid}/verify
```
...
```text
GET https://api-keymanager.gov-nhncloudservice.com/keymanager/v1.3/appkey/{appkey}/asymmetric-keys/{keyid}/privateKey?keyVersion={keyVersion}
```
...
```text
GET https://api-keymanager.gov-nhncloudservice.com/keymanager/v1.3/appkey/{appkey}/asymmetric-keys/{keyid}/publicKey?keyVersion={keyVersion}
```
...
```text
POST https://api-keymanager.gov-nhncloudservice.com/keymanager/v1.3/appkey/{appkey}/keys/secrets/create
```
...
```text
POST https://api-keymanager.gov-nhncloudservice.com/keymanager/v1.3/appkey/{appkey}/keys/symmetric-keys/create
```
...
```text
POST https://api-keymanager.gov-nhncloudservice.com/keymanager/v1.3/appkey/{appkey}/keys/asymmetric-keys/create
```
...
```text
PUT https://api-keymanager.gov-nhncloudservice.com/keymanager/v1.3/appkey/{appkey}/keys/{keyid}/delete
```
...
```text
DELETE https://api-keymanager.gov-nhncloudservice.com/keymanager/v1.3/appkey/{appkey}/keys/{keyid}
```
...
```text
POST https://api-keymanager.gov-nhncloudservice.com/keymanager/v1.3/appkey/{appkey}/auths/ipv4s
```
...
```text
POST https://api-keymanager.gov-nhncloudservice.com/keymanager/v1.3/appkey/{appkey}/auths/macs
```
...
```text
POST https://api-keymanager.gov-nhncloudservice.com/keymanager/v1.3/appkey/{appkey}/auths/certificates
```
...
```text
PUT https://api-keymanager.gov-nhncloudservice.com/keymanager/v1.3/appkey/{appkey}/auths/ipv4s/delete
```
...
```text
PUT https://api-keymanager.gov-nhncloudservice.com/keymanager/v1.3/appkey/{appkey}/auths/macs/delete
```
...
```text
PUT https://api-keymanager.gov-nhncloudservice.com/keymanager/v1.3/appkey/{appkey}/auths/certificates/delete
```
...
```text
POST https://api-keymanager.gov-nhncloudservice.com/keymanager/v1.3/appkey/{appkey}/auths/ipv4s/delete
```
...
```text
POST https://api-keymanager.gov-nhncloudservice.com/keymanager/v1.3/appkey/{appkey}/auths/macs/delete
```
...
```text
POST https://api-keymanager.gov-nhncloudservice.com/keymanager/v1.3/appkey/{appkey}/auths/certificates/delete
```
...
```text
GET https://api-keymanager.gov-nhncloudservice.com/keymanager/v1.3/appkey/{appkey}/keystores
```
...
```text
GET https://api-keymanager.gov-nhncloudservice.com/keymanager/v1.3/appkey/{appkey}/keystores?detail={detail}
```
...
```text
GET https://api-keymanager.gov-nhncloudservice.com/keymanager/v1.3/appkey/{appkey}/keystores/{keyStoreId}
```
...
```text
GET https://api-keymanager.gov-nhncloudservice.com/keymanager/v1.3/appkey/{appkey}/keystores/{keyStoreId}/keys
```
...
```text
GET https://api-keymanager.gov-nhncloudservice.com/keymanager/v1.3/appkey/{appkey}/keystores/{keyStoreId}/keys?detail={detail}&type={type}&name={name}&status={status}&pageNumber={pageNumber}&pageSize={pageSize}
```
...
```text
GET https://api-keymanager.gov-nhncloudservice.com/keymanager/v1.3/appkey/{appkey}/keystores/{keyStoreId}/keys/{keyId}
```
...
```text
GET https://api-keymanager.gov-nhncloudservice.com/keymanager/v1.3/appkey/{appkey}/keystores/{keyStoreId}/ips
```
...
```text
GET https://api-keymanager.gov-nhncloudservice.com/keymanager/v1.3/appkey/{appkey}/keystores/{keyStoreId}/ips?value={ipv4Value}
```
...
```text
GET https://api-keymanager.gov-nhncloudservice.com/keymanager/v1.3/appkey/{appkey}/keystores/{keyStoreId}/macs
```
...
```text
GET https://api-keymanager.gov-nhncloudservice.com/keymanager/v1.3/appkey/{appkey}/keystores/{keyStoreId}/macs?value={macValue}
```
...
```text
GET https://api-keymanager.gov-nhncloudservice.com/keymanager/v1.3/appkey/{appkey}/keystores/{keyStoreId}/certificates
```
...
```text
GET https://api-keymanager.gov-nhncloudservice.com/keymanager/v1.3/appkey/{appkey}/keystores/{keyStoreId}/certificates?value={certificateName}
```
