...
| 공통        | false | -2038 | 치환 후 templateSubtitle이 50자를 초과한 경우                                                                                                               | The templateSubtitle that is replaced by the template parameters can not exceed 50 characters.                                                                                                                                                                                                                                                                             |
...
| 공통        | false | -3341 | 잘못된 080 인증번호                                                                                                                                      | Invalid format. Only digits are allowed, up to a maximum of 10.                                                                                                                                                                                                                                                                                                             |
...
| 발송/조회     | false | -2038 | 치환 후 templateSubtitle이 50자를 초과한 경우                                                                                                               | The templateSubtitle that is replaced by the template parameters can not exceed 50 characters.                                                                                                                                                                                                                                                                             |
...
<tbody>
  ...
  <tr>
	...
	<tr>
		<td>3023</td>
		<td>메시지에 포함된 비디오를 전송할 수 없음(비디오 주소 또는 썸네일 이미지 주소가 올바르지 않거나 썸네일 이미지가 규격에 맞지 않음)</td>
	</tr>
	<tr>
		<td>3024</td>
