...
#### 기능 추가
* [콘솔] 알림톡 공용 템플릿 기능 추가
    * 주문, 결제, 배송 등 업종 관계 없이 범용적으로 사용가능한 메시지 템플릿을 제공합니다. 별도의 검수 과정 없이 사용 가능합니다.
* [콘솔, API] 브랜드 메시지 채널 출시
    * 카카오 브랜드 메시지 발송을 지원합니다.
    * 발송 대상: 고객사 회원 대상(M, N, O 그룹), 채널 친구 대상(기존 I타겟팅 발송)
    * 기존 Kakaotalk Bizmessage 상품의 브랜드 메시지 대비 주요 차이점:
        * O 그룹 타겟팅 추가: 고객사 광고성 수신동의 회원 중 채널 친구 대상 발송
