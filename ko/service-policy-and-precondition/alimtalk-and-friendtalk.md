...
브랜드 메시지는 광고주의 마케팅 수신 동의(이하 마수동) 회원을 대상으로 카카오톡 채널 친구 여부와 관계없이 광고성 메시지를 발송할 수 있는 카카오톡 비즈 메시지 상품입니다.

* 채널 친구뿐만 아니라, 마수동 사용자 중 비친구에게도 광고성 메시지를 발송할 수 있습니다.
* 브랜드 메시지는 광고성 메시지만 발송할 수 있습니다.
* LMS/MMS보다 저렴한 비용으로 텍스트 및 이미지를 포함하여 발송할 수 있습니다.
* 템플릿 및 자유형 발송이 가능합니다.
...
고객 대상 발송 사용 신청에 대한 자세한 내용은 **콘솔 사용 가이드** > **발신 정보** > **고객 대상 발송 사용 신청**을 참고하세요.

* **M**: 마케팅 수신 동의 사용자 전체를 대상으로 광고성 메시지를 발송합니다. 수신자가 채널 친구가 아닌 경우, 무료 수신거부 정보가 포함된 채널 메시지로 발송됩니다.
...
* 080 수신거부번호는 동일한 카카오톡 채널의 타 조직, 타 프로젝트, 타 딜러사의 발신 프로필 전체에 일괄 적용됩니다.
...
* 전송자의 명칭 및 연락처는 메시지 본문보다 상단에 작성되어야 합니다.
* 메시지에 수신 거부 및 수신 동의 철회 의사를 쉽게 할 수 있는 조치 및 방법을 구체적으로 표기해야 합니다.
* 수신 거부를 위해 별도의 추가적인 조치(로그인 등)를 거쳐야 하는 경우, 수신 거부를 어렵게 하는 것으로 법 위반에 해당합니다.
* 비즈니스 인증이 해제될 경우 비친구 메시지 발송(타겟팅 M, N) 사용 권한이 해제됩니다.
