<a id='section-1'></a>
## Network > Load Balancer(DSR) > 콘솔 사용 가이드 { #section-1 }

<a id='load-balancer-dsr-management'></a>
## 로드 밸런서(DSR) 관리 { #load-balancer-dsr-management }
...
<a id='load-balancer-dsr-management-1'></a>
### 로드 밸런서(DSR) 삭제 { #load-balancer-dsr-management-1 }
...
### 상태 확인 설정 변경 { #change-health-check-settings }
...
## 쿼터 및 제한 사항 { #quota-and-limitations }
