...
|---|---|---|---|
| acl | Array | ACL 목록 객체 |
| acl.id | String | ACL ID |
| acl.tenant_id | String | 테넌트 ID |
| acl.name | String | ACL 이름 |
| acl.description | String | ACL 설명 |
| acl.create_at | String | ACL 생성 시간 |
| acl.update_at | String | ACL 갱신 시간 |
...
| acl\_rule.created_at | Body | String | ACL Rule 생성 시간 |
| acl\_rule.updated_at | Body | String | ACL Rule 갱신 시간 |
