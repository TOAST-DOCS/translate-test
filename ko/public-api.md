...
| sort_dir | Query | Enum | N | 조회할 ACL의 정렬 방향<br>`sort_key`에서 지정한 필드를 기준으로 정렬<br>**asc**, **desc** 중 하나 |
| sort_key | Query | String | N | 조회할 ACL의 정렬 키<br>`sort_dir`에서 지정한 방향대로 정렬 |
| fields | Query | String | N | 조회할 ACL의 필드 이름<br>예) `fields=id&fields=name` |
...
|---|---|---|---|---|
| tokenId | Header | String | Y | 토큰 ID |
| sort_dir | Query | Enum | N | 조회할 ACL Rule의 정렬 방향<br>`sort_key`에서 지정한 필드를 기준으로 정렬<br>**asc**, **desc** 중 하나 |
...
|---|---|---|---|---|
| tokenId | Header | String | Y | 토큰 ID |
| aclBindingId | URL | UUID | Y | 조회할 ACL 바인딩 ID |
| fields | Query | String | - | 조회할 ACL 바인딩의 필드 이름<br>예: `fields=id&fields=name` |
...
| acl\_binding.acl_id | Body | String | 네트워크와 바인딩되는 ACL ID |
| acl\_binding.network_id | Body | String | ACL과 바인딩되는 네트워크 ID |
...
|---|---|---|---|---|
| tokenId | Header | String | Y | 토큰 ID |
| acl\_binding | Body | Array | Y | ACL 바인딩 목록 객체 |
| acl\_binding.tenant_id | Body | String | N | 테넌트 ID |
| acl\_binding.network_id | Body | String | Y | Network ID |
| acl\_binding.acl_id | Body | String | Y | ACL ID |
...
| 이름 | 구분 | 타입 | 필수 | 설명 |
|---|---|---|---|---|
| aclBindingId | URL | UUID | Y | 삭제할 ACL 바인딩 ID |
| tokenId | Header | String | Y | 토큰 ID |
