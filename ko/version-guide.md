...
| 버전 | 릴리스 | 서비스 지원 종료(업그레이드 지원) | 서비스 지원 종료(EOS) |
|------|--------|---------------------------------|---------------------|
| v1.28.3 | 2024. 2. | 2025.11.30 | 2025.11.30 |
| v1.29.3 | 2024. 5. | 2026.02.28 | 2026.02.28 |
| v1.30.3 | 2024. 8. | 2026.05.31 | 2026.05.31 |
| v1.31.4 | 2025. 2. | 2026.08.31 | 2026.08.31 |
| v1.32.3 | 2025. 5. | 2027.02.28 (예정) | 2027.02.28 (예정) |
...
| 1.202602.0 | 2026. 2. | v1.29–v1.33 | 기능 추가<br>- Kubernetes 테인트 설정 기능 <br>- Kubernetes 컴포넌트 설정 기능 max-pods 설정 지원 <br>- Secure Key Manager를 이용한 etcd 데이터 암호화 지원 <br>- CGroup v2 OS 이미지 지원<br><br>기능 개선<br>- 노드 및 노드 그룹 삭제 시 로드 밸런서 트래픽 유실 개선 |
| 1.202602.1 | 2026. 3. | v1.29–v1.33 | 기능 개선<br>- Service 객체로 생성된 LB의 안정성 강화 | 
| 1.202605.0 | 2026. 5. | v1.30–v1.34 | 기능 개선<br>- 워커 노드 CGroup v1 → v2 마이그레이션 지원<br>- Kubernetes v1.34 클러스터의 `ImageVolume` feature gate 활성화<br>- kube-apiserver와 pod 간의 통신을 위한 konnectivity 지원<br>- etcd 업그레이드 지원 |
| 1.202608.0 | 2026. 8. | v1.31–v1.35 | addon 설치/업데이트 실패 시 오류 메시지 표시 개선 |
...
| **1.202608.0** | v3.5.29 | k8s v1.33 이하: 1.7.27 </br> k8s v1.34 이상: 2.2.1 |
...
* 따라서 플랫폼 버전 1.202602.0 미만인 클러스터는 노드 그룹 추가 시 사용할 수 있는 이미지가 없을 수 있습니다. 
* CGroup v2인 OS 이미지를 사용하기 위해서는 플랫폼 버전을 1.202602.0 이상으로 업그레이드해야 합니다.
