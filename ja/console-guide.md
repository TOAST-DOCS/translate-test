...
保管中の作業リストを照会できます。**[履歴エクスポート]** ボタンをクリックすると、終了した作業リストをファイルとしてダウンロードできます。
...
<table class="it" style="padding-top: 15px; padding-bottom: 10px;">
  ...
  <tr>
    <td>実行パス</td>
    <td>コンテナで作業をリクエストしたパスを示します。<br>コンテナを空にする操作のようにすべてのオブジェクトを対象に実行された場合、またはコンテナの最上位パスで実行された作業の場合は、空の値として表示されます。</td>
  </tr>
  <tr>
    <td>種類</td>
    <td>作業の種類を示します。</td>
  ...
  <tr>
    <td><b>キャンセル中</b>: ユーザーのキャンセルリクエストを受け付け、キャンセル待ち中の状態です。</td>
  </tr>
  <tr>
  ...
  <tr>
    <td>進行カウンター</td>
    <td>処理を試みたオブジェクトの総数と、成功および失敗した件数を示します。</td>
  </tr>
  <tr>
    <td>失敗結果</td>
    <td>失敗結果を表示</td>
...
<table class="it" style="padding-top: 15px; padding-bottom: 10px;">
  ...
  <tr>
    <td>対象パス</td>
    <td>対象コンテナでオブジェクトがコピー/移動されるパスを示します。</td>
  </tr>
</table>
