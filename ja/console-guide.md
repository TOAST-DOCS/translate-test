...
* [コンテナの中身を空にする](#empty-a-container)
...
!!! tip "ヒント"
    作業履歴は、作業終了日から 90 日間保管されます。

<a id="task-record-list"></a>
##### 作業リスト

保管中の作業リストを照会できます。**[履歴のエクスポート]** ボタンをクリックすると、終了した作業リストをファイルとしてダウンロードできます。
...
<table class="it" style="padding-top: 15px; padding-bottom: 10px;">
  ...
  <tr>
    <td>実行パス</td>
    <td>コンテナで作業をリクエストしたパスを示します。<br>コンテナの中身を空にするなど、すべてのオブジェクトを対象に実行される作業、またはコンテナの最上位パスから実行された作業の場合は、空の値として表示されます。</td>
  </tr>
  <tr>
    <td>種類</td>
    <td>作業の種類を示します。</td>
  ...
  <tr>
    <td rowspan="6">ステータス</td>
    <td><b>待機中</b>: 作業作成直後、実行を待機している状態です。</td>
  </tr>
  <tr>
    <td><b>進行中</b>: 作業が実行中の状態です。</td>
  </tr>
  <tr>
    <td><b>完了</b>: 作業のすべてのオブジェクト処理が成功し、終了した状態です。</td>
  </tr>
  <tr>
    <td><b>失敗</b>: 作業の一部のオブジェクト処理が失敗したまま終了した状態です。</td>
  </tr>
  <tr>
    <td><b>キャンセル中</b>: ユーザーからのキャンセルリクエストを受け取り、キャンセルを待機している状態です。</td>
  </tr>
  <tr>
    <td><b>キャンセル済み</b>: キャンセルが完了し、終了した状態です。</td>
  </tr>
  <tr>
    <td rowspan="6">進行 / 結果</td>
    <td>ユーザー</td>
    <td>作業をリクエストしたユーザーの ID を示します。</td>
  </tr>
  <tr>
    <td>作業リクエスト日時</td>
    <td>ユーザーが作業をリクエストした日時を示します。</td>
  </tr>
  <tr>
    <td>作業開始日時</td>
    <td>ユーザーがリクエストした作業の処理が開始された日時を示します。</td>
  </tr>
  <tr>
    <td>作業終了日時</td>
    <td>作業が終了した日時を示します。</td>
  </tr>
  <tr>
    <td>所要時間合計</td>
    <td>作業が開始してから終了するまでの所要時間を示します。</td>
  </tr>
  <tr>
    <td>進行カウンター</td>
  ...
  <tr>
    <td>失敗結果</td>
    <td>失敗結果を表示</td>
    <td>失敗したオブジェクトのリストと、オブジェクトごとの失敗理由およびリクエスト日時などを確認できます。</td>
  </tr>
</table>
...
<table class="it" style="padding-top: 15px; padding-bottom: 10px;">
  ...
  <tr>
    ...
    <td>対象コンテナ</td>
    <td>オブジェクトのコピー/移動先のコンテナ名を示します。</td>
  </tr>
  <tr>
    <td>対象パス</td>
    <td>対象コンテナ内でオブジェクトがコピー/移動されるパスを示します。</td>
  </tr>
</table>
