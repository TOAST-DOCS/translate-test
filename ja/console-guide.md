...
## Network > Transit Hub > コンソール使用ガイド { #network-transit-hub-console-user-guide }
...
### トランジットハブの作成 { #create-transit-hub }
...
### トランジットハブの変更 { #modify-transit-hub }
...
### トランジットハブの削除 { #delete-transit-hub }
...
### ルーティングテーブル変更 { #modify-routing-table }
...
### ルーティングテーブルの削除 { #delete-routing-table }
...
### ルーティングテーブルの管理 { #manage-routing-table }
...
### マルチキャストドメインの作成 { #create-multicast-domain }
...
### マルチキャストドメインの変更 { #modify-multicast-domain }
...
### マルチキャストドメインの削除 { #delete-multicast-domain }
...
### マルチキャストドメインの共有 { #share-multicast-domain }
...
## 共有されたトランジットハブ { #shared-transit-hub }
...
## 接続(共有されたトランジットハブ) { #attachment-shared-transit-hub }

共有されたトランジットハブと他のリソースとの関係を定義する接続を管理します。

<a id="attachment-shared-transit-hub-create-attachment"></a>
### 接続作成 { #attachment-shared-transit-hub-create-attachment }
...
### 接続変更 { #attachment-shared-transit-hub-modify-attachment }
...
### 接続削除 { #attachment-shared-transit-hub-delete-attachment }
...
## マルチキャスト(共有されたマルチキャストドメイン) { #multicast-shared-multicast-domains }

共有されたマルチキャストドメインのマルチキャスト通信に参加するためのリソースを管理します。

<a id="manage-shared-multicast"></a>
### 共有されたマルチキャスト管理 { #manage-shared-multicast }
