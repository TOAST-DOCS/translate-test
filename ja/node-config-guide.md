...
<a id="message-imported-by-codec-2"></a>
...
<a id="message-imported-by-codec-3"></a>
...
<a id="node-description-4"></a>

### ノードの説明
* NHN CloudのData Lake Storageからデータを入力するノードです。

<a id="execution-mode-5"></a>
...
<a id="message-imported-by-codec-4"></a>
...
<a id="execution-mode-7"></a>

### 実行モード
STREAMING：キューに新しいメッセージが到着するたびにデータを処理します。

<a id="property-description-6"></a>
...
<a id="message-ingestion-by-codec-type-2"></a>
...
<a id="node-description-6"></a>

### ノードの説明

Kafkaからデータを受信するノードです。

<a id="execution-mode-8"></a>
...
<a id="message-imported-by-codec-5"></a>
...
<a id="node-description-8"></a>

### ノードの説明
CSV形式のメッセージをパースしてフィールドに保存するノードです。

<a id="property-description-9"></a>
...
<a id="node-description-9"></a>

### ノードの説明

JSON文字列をパースして指定されたフィールドに保存するノードです。

<a id="property-description-10"></a>
...
<a id="how-to-enter-a-schema-2"></a>

#### スキーマ入力方法
カラムタイプはサポートしておらず、全てのカラムとデータタイプをスキーマとして入力します。

<a id="example-of-csv-parsing-without-data-type-conversion-2"></a>
...
<a id="node-description-10"></a>

### ノードの説明

Date文字列をパースしてtimestamp形式で保存するノードです。

<a id="property-description-11"></a>
...
<a id="node-description-11"></a>

### ノードの説明

UUIDを生成してフィールドに保存するノードです。

<a id="property-description-12"></a>
...
<a id="node-description-12"></a>

### ノードの説明

特定のフィールドのデータタイプを変換するノードです。

<a id="property-description-13"></a>
...
<a id="node-description-13"></a>

### ノードの説明

null値をデフォルト値に置き換えるノードです。

<a id="property-description-14"></a>
...
<a id="node-description-14"></a>

### ノードの説明

既存のフィールドを別のフィールドにコピーするノードです。

<a id="property-description-15"></a>
...
<a id="node-description-15"></a>

### ノードの説明

フィールド名を変更するノードです。

<a id="property-description-16"></a>
...
<a id="node-description-16"></a>

### ノードの説明

フィールドの文字列の先頭と末尾の空白を削除するノードです。

<a id="property-description-17"></a>
...
<a id="node-description-17"></a>

### ノードの説明

フィールドを削除するノードです。

<a id="property-description-18"></a>
...
<a id="node-description-18"></a>

### ノードの説明

正規表現を使用して文字列フィールドをトークン化するノードです。

<a id="property-description-19"></a>
...
<a id="property-description-20"></a>
...
<a id="node-description-20"></a>

### ノードの説明

文字列配列フィールドに含まれるストップワード(Stop Word)を削除するノードです。

<a id="property-description-21"></a>
...
<a id="property-description-22"></a>
...
<a id="property-description-23"></a>
...
<a id="property-description-24"></a>
...
<a id="output-examples-by-codec-type-2"></a>
...
<a id="property-description-25"></a>
...
<a id="output-examples-by-codec-type-3"></a>
...
<a id="node-description-25"></a>

### ノードの説明
NHN CloudのEasyQueueにデータを送信するノードです。

<a id="property-description-26"></a>
...
<a id="output-examples-by-codec-type-4"></a>
...
<a id="node-description-26"></a>

### ノードの説明

Kafkaにデータを送信するノードです。

<a id="property-description-27"></a>
...
<a id="output-examples-by-codec-type-5"></a>
...
<a id="node-description-28"></a>

### ノードの説明

条件文でメッセージをフィルタリングするノードです。

<a id="property-description-28"></a>
...
<a id="property-description-29"></a>
