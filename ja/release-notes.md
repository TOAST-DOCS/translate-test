...
* [iOS] 1.6.0
    ...
    * 安定性の改善
* [Unity] 0.5.2
    * iOS環境で SecureValue が改ざんされた際に遮断が正常に動作しない問題を修正しました。
...
* [Console]
    ...
    * Android ID基準のブラックリスト遮断機能を追加
        * ブラックリストで Android IDを基準に特定の端末を遮断できるように機能を追加しました。
