...
* [Android] 1.14.0.0
    * DEX 暗号化対象指定機能の追加
        * パッケージまたはクラス単位で DEX 暗号化の対象を選択できる機能を追加しました。
        * 詳細については、**Android Developer's Guide > 3. 統合設定ファイル > 3.2 機能別設定 > DEX 暗号化対象指定**を参照してください。
    * 統合設定ファイルのサポート
        * リソース文字列の難読化ルールと DEX 暗号化範囲を 1 つの統合設定ファイルで管理できるように改善しました。
        * 詳細については、**Android Developer's Guide > 3. 統合設定ファイル**を参照してください。
    * Android ID 基準ブラックリスト機能の追加
        * Android ID を基準に特定の端末をブラックリストに登録できる機能を追加しました。
    * バグ修正
        * MyCard 決済時にアプリが異常終了する問題を修正しました。
        * リモート制御アプリの検知時に発生する誤検知を修正しました。
    * 安定性の改善
* [iOS] 1.6.0
    * iOS 最小サポートバージョンの引き上げ
        * 最小サポートバージョンを iOS 13 に引き上げました。
    * 安定性の改善
* [Unity] 0.5.2
    * iOS 環境で SecureValue が改ざんされた際に遮断が正常に動作しない問題を修正しました。
    * iOS SDK 1.6.0 アップデート
* [Unreal] 0.2.11
    * iOS SDK 1.6.0 アップデート
* [Console]
    * Android 統合設定ファイルアップロード機能の追加
        * Android アプリ保護作業に使用する統合設定ファイルをアップロードできる機能を追加しました。
    * Android ID 基準ブラックリスト遮断機能の追加
        * ブラックリストで Android ID を基準に特定の端末を遮断できるように機能を追加しました。
