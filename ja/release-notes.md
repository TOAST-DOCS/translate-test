...
* DNS (Domain Name System) でドメインを簡単に設定および管理できます。
* GSLB (Global Server Load Balancing) でルーティングルールに従って、エンドポイントサーバーを DR (Disaster Recovery)、ランダムロードバランシング、グローバルロードバランシングとして構成できます。
{% else %}
