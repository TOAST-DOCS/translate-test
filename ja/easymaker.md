...
ノートブックの状態が表示されます。主な状態については、以下の表を参考してください。

| 状態               | 説明                                                                                                                              |
| ------------------ | --------------------------------------------------------------------------------------------------------------------------------- |
| CREATE REQUESTED   | ノートブック生成がリクエストされた状態です。                                                                                                  |
| CREATE IN PROGRESS | ノートブックインスタンスを生成中の状態です。                                                                                           |
...
学習後、TensorBoard画面で結果指標を確認するために、学習スクリプト作成時にTensorBoardログ保存場所を指定位置(`EM_TENSORBOARD_LOG_DIR`)に設定する必要があります。
