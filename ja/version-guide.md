...
|------|--------|---------------------------------|---------------------|
| v1.33 | 2025年11月 | 2027.01.31 | 2027.11.30 |
| v1.34 | 2026年5月 | 2027.07.31 | 2028.05.31 |
| v1.35 | 2026年8月 | 2027.10.30 | 2028.08.31 |
...
| 1.202511.1 | 2025. 12. | v1.28–v1.33 | ヘルスチェック確認ポート設定のエラー修正 |
| 1.202602.0 | 2026. 2. | v1.29–v1.33 | 機能追加<br>- Kubernetes テイント設定機能 <br>- Kubernetes コンポーネント設定機能 max-pods 設定のサポート <br>- Secure Key Manager を利用した etcd データ暗号化のサポート <br>- CGroup v2 OS イメージのサポート<br><br>機能改善<br>- ノードおよびノードグループ削除時のロードバランサートラフィック損失の改善 |
...
| 1.202608.0 | 2026. 8. | v1.31–v1.35 | addon インストール/アップデート失敗時のエラーメッセージ表示の改善 |
