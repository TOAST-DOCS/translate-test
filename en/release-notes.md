...
* [Android] 1.14.0.0
    * Added DEX encryption target specification
        * Added a feature that allows you to select DEX encryption targets by package or class.
        * For more information, see **Android Developer's Guide > 3. Unified Settings File > 3.2 Settings by Feature > DEX Encryption Target Specification**.
    * Added support for unified settings file
        * Improved to allow you to manage resource string obfuscation rules and DEX encryption scope in a single unified settings file.
        * For more information, see **Android Developer's Guide > 3. Unified Settings File**.
    * Added Android ID-based blacklist feature
        * Added a feature that allows you to register specific devices in the blacklist based on Android ID.
    * Added emulator detection patterns
        * Added a detection pattern for the UgPhone emulator.
    * Bug fixes
...
* [Unreal] 0.2.11
    * Updated to iOS SDK 1.6.0
* [Console]
    * Added Android unified settings file upload feature
        * Added a feature that allows you to upload a unified settings file to use for Android app protection tasks.
    * Added Android ID-based blacklist blocking feature
        * Added a feature that allows you to block specific devices based on Android ID in the blacklist.
