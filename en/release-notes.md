...
* Added the **Use Resource Versioning** option to the **Deploy - Deploy** stage
  * If you turn off this option, resources are deployed with the original names defined in the manifest.
  * For more information, see the [Pipeline Stage Guide](/Dev%20Tools/Pipeline/en/stage-guide/).
