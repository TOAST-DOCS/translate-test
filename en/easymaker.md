...
The status of notebooks is displayed. Refer to the following table for the main statuses.
...
To check the result metrics on the TensorBoard screen after training, you must set the TensorBoard log save location to the specified path (`EM_TENSORBOARD_LOG_DIR`) when writing your training script.
