...
To view the results metrics on the TensorBoard screen after training, set the TensorBoard log storage path to the specified location (`EM_TENSORBOARD_LOG_DIR`) when writing your training script.
