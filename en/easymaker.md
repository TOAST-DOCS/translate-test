...
To view the training results on the TensorBoard screen after training, you must set the TensorBoard log storage path to the specified location (`EM_TENSORBOARD_LOG_DIR`) when writing your training script.
