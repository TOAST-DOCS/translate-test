...
| ACTIVE (UNHEALTHY) | Notebook application is not running normally. If this status persists even after restarting the notebook, please contact customer support. |
