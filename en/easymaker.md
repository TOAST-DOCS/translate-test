...
| ACTIVE (UNHEALTHY) | The state where the notebook application is not running normally. If this state persists even after restarting the notebook, contact customer support. |
