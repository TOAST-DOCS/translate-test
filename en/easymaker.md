...
To view training result metrics on the TensorBoard screen, you must set the TensorBoard log storage location to the designated path (`EM_TENSORBOARD_LOG_DIR`) when writing your training script.
