...
To view training result metrics on the TensorBoard screen after training, set the TensorBoard log storage location to the specified location (`EM_TENSORBOARD_LOG_DIR`) when writing your training script.
