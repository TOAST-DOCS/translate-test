...
* If you search by both the registration date and the delivery date, the delivery date is ignored.
...
| msgStatus            | 	String  | 1     | 	Optional | Message status code (0: Failed, 1: Requested, 2: Processing, 3: Succeeded, 4: Reservation cancelled, 5: Duplicate failure, 6: Failed (ad restriction), 7: Waiting for resend (ad restriction)) |
| resultCode           | 	String  | 10    | 	Optional | 	Reception result code [[Code Table](./error-code/#_2)]                                                                                                                              |
| subResultCode        | 	String  | 10    | 	Optional | 	Reception result detail code [[Code Table](./error-code/#_3)]                                                                                                                       |
...
| countryCode          | 	String  | -     | 	Optional | 	Country code [[Supported Countries](./international-sending-policy/#_5)]                                                                                                             |
| pageNum              | 	Integer | -     | 	Optional | 	Page number (default: 1)                                                                                                                                                             |
...
The rules for the required advertising phrase are as follows:
- Opening phrase: `(광고)`
- Closing phrase: `무료수신거부 {080수신거부번호}` or `무료거부 {080수신거부번호}` 
  - The phrase may include spaces.
  - A hyphen (-) may be included between digits of the 080 opt-out number.
