...
| Common        | false | -2037 | When registering a template including an item list, if the number of characters in the message body exceeds 700                                                                                                   | The 'content' is too long. If you request the 'templateItem', It must be less than 1000 characters.                                                                                                                                                                                                                                                                        |
| Common        | false | -2502 | If fallback is requested without a delivery failure configuration                                                                                                              | Please set up plus-friend resend setting.                                                                                                                                                                                                                                                                                                                                  |
...
| Common | false | -3007 | App Link (AL) must enter at least two of schemeAndroid, schemeIos, or linkMo. | If there is an AL(appLink) in the template, at least two of schemeAndroid, schemeIos, linkMo must be entered. |
...
| Common | false | -3010 | If it does not match the registered template body | The contents are not matched to template. This message can be resend by sms service if the resend setting is on. |
...
| Common | false | -3051 | TN button name must be one of the following: "Direct Call", "Customer Center", "Contact a Representative". | TN button name must be one of: 전화 연결, 고객센터 연결, 상담원 연결 |
...
| Common | false | -3306 | The commerce type message must include buttons. | The commerce type require buttons. |
...
| Common | false | -4005 | Appkey is disabled. | Appkey is disabled status. |
...
| Common | false | -4020 | Failed to read file | Failed to reading the file. |
...
| Kakao Statistics | false | -4105 | Invalid parameter | {parameter}: {error message} |
