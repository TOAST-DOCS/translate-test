...
| distributions[0].origins[0].httpPort                                                  | Integer | Optional    |             | See '[Table 2] Available Origin Server Port Numbers' of [Console User Guide > Origin Server](./console-guide/#origin-server-port) | HTTP protocol port of the origin server (one of origins[0].httpPort and origins[0].httpsPort must be entered.)                                         |
| distributions[0].origins[0].httpsPort                                                 | Integer | Optional    |             | See '[Table 2] Available Origin Server Port Numbers' of [Console User Guide > Origin Server](./console-guide/#origin-server-port) | HTTPS protocol port of the origin server (one of origins[0].httpPort and origins[0].httpsPort must be entered.)                                        |
...
### Query Cache Purge { #query-cache-purge }
...
## Alias Domain API { #alias-domain-api }

<a id="register-alias-domain"></a>
### Register Alias Domain { #register-alias-domain }
...
### List Alias Domains { #list-alias-domains }
...
### Delete Alias Domain { #delete-alias-domain }
