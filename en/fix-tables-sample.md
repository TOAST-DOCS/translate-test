...
The same section in en/ja does not have the table below. Because the number of tables in the section differs from ko, the maintenance run must recreate the body of this section based on ko.
