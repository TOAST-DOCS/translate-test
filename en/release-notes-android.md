...
* Fixed an issue where notification click actions were executed repeatedly
    * Fixed an issue where, on Android 12 or later, tapping a notification with a click action set to a URL and then reopening the app from the recent apps list caused the click action to be executed repeatedly, preventing the user from entering the app.
