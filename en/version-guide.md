...
|------|--------|---------------------------------|---------------------|
| v1.33 | November 2025 | 2027.01.31 | 2027.11.30 |
| v1.34 | May 2026 | 2027.07.31 | 2028.05.31 |
...
| Version | Release | End of Service Support (Upgrade Support) | End of Service Support (EOS) |
|------|--------|---------------------------------|---------------------|
| v1.28.3 | Feb. 2024 | Nov. 30, 2025 | Nov. 30, 2025 |
| v1.29.3 | May 2024 | February 28, 2026 | February 28, 2026 |
| v1.30.3 | August 2024 | May 31, 2026 | May 31, 2026 |
| v1.31.4 | February 2025 | August 31, 2026 | August 31, 2026 |
| v1.32.3 | May 2025 | 2027.02.28 (Planned) | 2027.02.28 (Planned) |
...
|------|------------|--------------------|-----|
| 1.202505.0 | November 2025 | v1.28–v1.32 | Indicates a cluster with no platform version applied. |
| 1.202511.0 | November 2025 | v1.28–v1.33 | Initial platform version release |
| 1.202511.1 | 2025. 12. | v1.28–v1.33 | Fixed an issue with the health check port configuration |
| 1.202602.0 | Feb. 2026 | v1.29–v1.33 | Added Features<br>- Kubernetes taint configuration <br>- Support for Kubernetes component configuration for max-pods <br>- Support for etcd data encryption with Secure Key Manager <br>- Support for CGroup v2 OS image<br><br>Feature Updates<br>- Support for improved traffic handling during node and node group deletion |
| 1.202602.1 | 2026. 3. | v1.29–v1.33 | Improved<br>- Enhanced stability of LBs created as Service objects |
| 1.202605.0 | May 2026 | v1.30–v1.34 | Feature Updates<br>- Added support for worker node CGroup v1 → v2 migration<br>- Enabled `ImageVolume` feature gate for Kubernetes v1.34 clusters<br>- Added support for konnectivity for communication between kube-apiserver and pods<br>- Added support for etcd upgrade |
| 1.202608.0 | August 2026 | v1.31–v1.35 | Improved error message display when addon installation/update fails |
...
| **1.202608.0** | v3.5.29 | k8s v1.33 or lower: 1.7.27 </br> k8s v1.34 or later: 2.2.1 |
