...
* [Copy objects](#copy-or-move-object)
* [Move objects](#copy-or-move-object)
...
You can view a list of tasks that are currently being retained. Click the **Export History** button to download the list of completed tasks as a file.

<a id="task-record-detail"></a>
##### Task Details

You can view detailed information for each task. The following information is available:
...
<table class="it" style="padding-top: 15px; padding-bottom: 10px;">
  ...
  <tr>
    ...
    <td>Indicates the path from which the task was requested in the container.<br>If the task was performed on all objects (such as emptying a container) or was executed from the root path of the container, this field is displayed as empty.</td>
  </tr>
  <tr>
    <td>Type</td>
  ...
  <tr>
    ...
    <td><b>Pending</b>: The task is waiting to be executed immediately after creation.</td>
  </tr>
  <tr>
  ...
  <tr>
    <td><b>Canceled</b>: The task has ended after the cancellation was completed.</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>You can view the list of failed objects along with the reason for failure and request time for each object.</td>
  </tr>
</table>
...
<table class="it" style="padding-top: 15px; padding-bottom: 10px;">
  ...
  <tr>
    ...
    <td>Indicates the path within the destination container to which the object is copied/moved.</td>
  </tr>
</table>
