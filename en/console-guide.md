...
!!! tip "Note"
    ...
    If a suspension occurs in a non-Enabled - Normal status (Enabled - Pending, Enabled - Insufficient Data), the data acquisition process for training and inference may be reset. In this case, at least 6 additional hours may be required depending on the status before the suspension.
