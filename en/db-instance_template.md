...
You can upload an external {{engine.pascalCase}} backup file to NHN Cloud Object Storage to restore it to a DB instance in RDS for {{engine.pascalCase}}. For more information, refer to [Restore with External {{engine.pascalCase}} Backup](backup-and-restore/#restore-from-external).
...
After backup, you can export backup files to Object Storage. For more details, see [Export Backup](backup-and-restore/#export).
