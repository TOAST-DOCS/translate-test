...
<a id="terraform"></a>
## Terraform
Terraform is an open-source tool that enables you to easily build infrastructure, safely make changes, and efficiently manage infrastructure configurations. The main features of Terraform are as follows:
...
* **Execution Plan**
    * You can separate the change plan from the change application to reduce errors that may occur when applying changes.
* **Resource Graph**
    * You can preview how small changes will affect your entire infrastructure.
    * You can create a dependency graph, use this graph to create a plan, and verify the changed infrastructure state when the plan is applied.
* **Change Automation**
    * You can automate building and changing infrastructure with the same configuration across multiple locations.
    * You can save time spent building infrastructure and reduce errors.
...
* **Component names and numbers, including versions, may change. Please check before use.**
...
* **password**
    ...
    * For information on how to set the API password, refer to **User Guide > Compute > Instance > Prepare for API Usage**.
* **auth_url**
