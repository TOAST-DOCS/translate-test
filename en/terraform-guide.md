...
* **Infrastructure as Code**
    ...
    * You can easily share the code you have defined, enabling efficient collaboration.
* **Execution Plan**
...
* **Resource Graph**
    ...
    * You can create a dependency graph, make plans based on this graph, and check the infrastructure state that changes when the plan is applied.
* **Change Automation**
    * You can automate the creation and modification of the same infrastructure configuration in multiple locations.
