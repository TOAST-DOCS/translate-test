...
<a id="terraform"></a>
## Terraform
Terraform is an open-source tool that makes it easy to build infrastructure, safely change it, and efficiently manage infrastructure configuration. Key features of Terraform are as follows:
...
* **Resource Graph**
    ...
    * You can create a dependency graph and plan based on it, and verify how the infrastructure state changes when the plan is applied.
* **Change Automation**
    * You can automate the construction and modification of infrastructure with the same configuration in multiple locations.
    * You can save time and reduce mistakes in building infrastructure.
...
* **tenant_id**
    * Click the **API Endpoint Settings** button in the **Compute > Instance > Management** menu of the NHN Cloud console to verify your tenant ID.
* **password**
...
* **auth_url**
    ...
    * Click the **API Endpoint Settings** button in the **Compute > Instance > Management** menu of the NHN Cloud console to verify the identity service URL.
* **region**
