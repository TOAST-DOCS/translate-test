...
* **Resource Graph**
    ...
    * You can create a dependency graph, create a plan based on this graph, and verify the changed infrastructure state when applying the plan.
* **Change Automation**
...
* **tenant_id**
    * Click the **API Endpoint Setting** button in the **Compute > Instance > Manage** menu of the NHN Cloud console to verify your tenant ID.
* **password**
    * Uses the **API Password** saved in the **API Endpoint Setting** dialog.
    * For information on how to set the API password, refer to **User Guide > Compute > Instance > API Usage Preparation**.
* **auth_url**
    * Specifies the NHN Cloud identity service address.
    * Click the **API Endpoint Setting** button in the **Compute > Instance > Manage** menu of the NHN Cloud console to verify the identity service URL.
* **region**
