...
* **Infrastructure as Code**
    ...
    * You can easily share defined code to collaborate efficiently.
* **Execution Plan**
...
* **Change Automation**
    * You can automate the creation and modification of the same infrastructure configuration across multiple locations.
...
Download the file that matches your local PC's operating system from the [Terraform download page](https://www.terraform.io/downloads.html). Extract the file, place it in your desired path, and add that path to your environment configuration to complete the installation.
...
The provider version should be written with reference to the `VERSION` information in the [NHN Cloud Terraform Registry](https://registry.terraform.io/providers/nhn-cloud/nhncloud/latest).
...
* **tenant_id**
    * Click the **API Endpoint Settings** button in the **Compute > Instance > Management** menu in the NHN Cloud console to verify the tenant ID.
* **password**
    * Use the **API Password** saved in the **API Endpoint Settings** dialog box.
    * For information on how to set the API password, see **User Guide > Compute > Instance > API Usage Preparation**.
* **auth_url**
    * Specify the NHN Cloud identity service address.
    * Click the **API Endpoint Settings** button in the **Compute > Instance > Management** menu in the NHN Cloud console to verify the identity service (identity) URL.
* **region**
    * Enter region information for managing NHN Cloud resources.
