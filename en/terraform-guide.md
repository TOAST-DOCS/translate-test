...
* **Resource Graph**
    * You can see in advance how minor changes affect the entire infrastructure.
    * You can create a dependency graph, make plans based on this graph, and check the state of infrastructure changes when applying the plan.
* **Change Automation**
