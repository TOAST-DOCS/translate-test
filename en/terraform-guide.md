...
## Third-party > Terraform User Guide
...
* **Resource Graph**
    ...
    * You can create a dependency graph, make plans based on this graph, and check the changed infrastructure state when the plan is applied.
* **Change Automation**
    * You can automate the construction and modification of the same configuration infrastructure in multiple locations.
...
* **tenant_id**
    * In the NHN Cloud console, go to **Compute > Instance > Management** menu and click the **API Endpoint Settings** button to check the tenant ID.
* **password**
...
* **auth_url**
    ...
    * In the NHN Cloud console, go to **Compute > Instance > Management** menu and click the **API Endpoint Settings** button to check the identity service URL.
* **region**
