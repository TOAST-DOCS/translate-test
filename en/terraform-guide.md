...
* **Infrastructure as Code**
    ...
    * You can easily share the defined code to collaborate efficiently.
* **Execution Plan**
...
* **Resource Graph**
    ...
    * You can create a dependency graph and use it to make plans, and check the infrastructure state changes when the plan is applied.
* **Change Automation**
    * You can automate the process of building and changing infrastructure with the same configuration in multiple locations.
...
* **The names and numbers of components including versions may change, so please verify before use.**


<a id="terraform-installation"></a>
## Install Terraform
Download the file that matches your local PC's operating system from the [Terraform download page](https://www.terraform.io/downloads.html). Extract the file and place it in the desired path, then add that path to your environment settings to complete the installation.
...
* **tenant_id**
    * Click the **API Endpoint Setting** button in **Compute > Instance > Management** menu in the NHN Cloud console to check the tenant ID.
* **password**
    * Use the **API Password** saved in the **API Endpoint Setting** dialog.
    * For API password setup instructions, refer to **User Guide > Compute > Instance > Preparing for API Use**.
* **auth_url**
    * Specifies the NHN Cloud identity service address.
    * Click the **API Endpoint Setting** button in **Compute > Instance > Management** menu in the NHN Cloud console to check the identity service URL.
* **region**
