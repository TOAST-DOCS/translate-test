...
* **Resource Graph**
    ...
    * By creating a dependency graph, you can make plans based on this graph and check the infrastructure state changes when applying the plan.
* **Change Automation**
    * You can automate the construction and modification of infrastructure with the same configuration in multiple locations.
    * This saves time in building infrastructure and reduces mistakes.
