...
* **Infrastructure as Code**
    ...
    * You can efficiently collaborate by easily sharing defined code.
* **Execution Plan**
...
* **Resource Graph**
    ...
    * You can create a dependency graph, create a plan based on this graph, and check the infrastructure state changes when applying this plan.
* **Change Automation**
...
* **Component names and numbers including versions may change, so please check and use accordingly.**
...
* **password**
    ...
    * For information on how to set the API password, refer to **User Guide > Compute > Instance > Preparing to Use API**.
* **auth_url**
