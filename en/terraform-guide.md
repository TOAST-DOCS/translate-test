...
* **Resource Graph**
    * You can check in advance how minor changes will impact the entire infrastructure.
    * You can create a dependency graph, plan based on this graph, and check the changed infrastructure state when the plan is applied.
* **Change Automation**
...
Download the file suitable for your local PC's operating system from the [Terraform Download page](https://www.terraform.io/downloads.html). Decompress the file, place it in your desired path, and then add that path to your environment settings to complete the installation.

The following is an example installation on Linux (Ubuntu/Debian).
...
* **tenant_id**
    * Click the **API Endpoint Settings** button in the **Compute > Instance > Management** menu of the NHN Cloud console to check the tenant ID.
* **password**
