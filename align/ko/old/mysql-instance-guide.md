...
## Compute > Instance > 특화된 인스턴스 사용 가이드 > MySQL Instance 가이드 { #compute-instance-instance-guide-mysql-instance-guide }
...
## MySQL 이미지 생성 후 초기 설정 { #initial-setting-after-mysql-image-created }

<a id="1-change-passwords"></a>
### 1\. 비밀번호 변경 { #1-change-passwords }
