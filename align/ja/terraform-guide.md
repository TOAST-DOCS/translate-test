...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (No corresponding ko heading; 'Local provider設定' subheading under t7 has no ko counterpart under k7) -->
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (No corresponding ko heading; 'Local providerの交換' subheading under t9 has no ko counterpart under k8) -->
### Local providerの交換
