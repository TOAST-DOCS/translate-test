...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (No ko counterpart: 'Local provider設定' is an additional subheading under k7 not present in the ko outline) -->
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (No ko counterpart: 'Local providerの交換' is an additional subheading under k8 not present in the ko outline) -->
