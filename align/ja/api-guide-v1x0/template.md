...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (L3 sub-heading under t15 (k1); ko source has no L3 sub-headings under k1) -->
### リクエスト
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (L3 sub-heading under t21 (k2); ko source has no L3 sub-headings under k2) -->
### リクエスト
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (L3 sub-heading under t27 (k3); ko source has no L3 sub-headings under k3) -->
### リクエスト
