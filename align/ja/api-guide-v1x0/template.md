...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (L3 subheading under t15 (k1 section); ko source has no L3 subsections under this heading) -->
### リクエスト
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (L3 subheading under t21 (k2 section); ko source has no L3 subsections under this heading) -->
### リクエスト
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (L3 subheading under t27 (k3 section); ko source has no L3 subsections under this heading) -->
### リクエスト
