...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (L3 subheading under t15 (k1); no corresponding subheading exists in the KO source for this section) -->
### リクエスト
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (L3 subheading under t21 (k2); no corresponding subheading exists in the KO source for this section) -->
### リクエスト
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (L3 subheading under t27 (k3); no corresponding subheading exists in the KO source for this section) -->
### リクエスト
