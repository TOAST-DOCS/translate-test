...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (リクエスト heading under 添付ファイルのアップロード (t84) has no counterpart in ko source: k86 section contains only cURL, レスポンス, and upload example subheadings) -->
<a id="request-18"></a>
