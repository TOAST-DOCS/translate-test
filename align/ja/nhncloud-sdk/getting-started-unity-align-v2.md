...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (New organizational wrapper heading (설定) grouping Android and iOS sections; restructured from separate L2 sections (k8, k24) into nested L3 sections under this container) -->
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (設定 is a new top-level section not in ko) -->
## 設定

<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (Android as L2 section is restructured from ko's Android 빌드 설정) -->
<a id="android-build-setup"></a>
...
##### support-annotationsバージョンが27.1.1超の場合

<!-- TODO: translate body -->

<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (iOS as L2 section is restructured from ko's iOS 빌드 설정) -->
<a id="ios-build-setup"></a>
