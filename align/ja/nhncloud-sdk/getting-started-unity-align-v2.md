...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (generic 'settings' heading not in ko structure) -->
## 設定

<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (standalone 'Android' section not matching ko structure) -->
### Android
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (standalone 'iOS' section not matching ko structure) -->
### iOS
