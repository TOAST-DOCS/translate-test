...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (no ko counterpart - Android section with wrong level) -->
...
##### support-annotations バージョンが27.1.1以下の場合

<!-- TODO: translate body -->

##### support-annotations バージョンが27.1.1超過の場合
