...
## Network > Traffic Mirroring > コンソール使用ガイド { #network-traffic-mirroring-console-user-guide }

コンソールでTraffic Mirroringサービスを使用する方法を説明します。

<a id="manage-a-mirror-session"></a>
## ミラーセッション管理 { #manage-a-mirror-session }
...
### ミラーセッション情報を確認する { #about-mirror-session-information }
...
### ミラーセッションの修正 { #modify-a-mirror-session }
...
### ミラーフィルタグループを確認する { #about-mirror-filter-groups }
