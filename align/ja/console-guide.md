...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (※参考 note inserted under 発信番号に名義者に基づく認証方法 (t8); no corresponding heading in KO source) -->
#### ※参考
* 本人認証後に発信番号の登録が可能です。
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (※参考 note inserted under 発信番号の登録形式 (t11); no corresponding heading in KO source) -->
#### ※参考
