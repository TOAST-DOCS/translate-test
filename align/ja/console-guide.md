...
## Network > Security Groups > コンソール使用ガイド { #network-security-groups-console-user-guide }

<a id="security-management-group"></a>
## セキュリティグループ管理 { #security-management-group }

<a id="creating-security-groups"></a>
### セキュリティグループ作成 { #creating-security-groups }
...
### セキュリティポリシー作成 { #create-security-rules }
...
### セキュリティルール一括作成 { #create-security-rules-in-bulk }
...
### セキュリティルール一覧のダウンロード { #download-the-list-of-security-rules }
セキュリティグループに設定されたセキュリティルール一覧をファイルとしてダウンロードできます。

<a id="applying-security-groups"></a>
### セキュリティグループ適用 { #applying-security-groups }
