...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (Duplicate of t6 (適用準備 / 適用準備); the ko outline has only one k6 entry for 適用準備 in this position, and t9 has no distinct ko counterpart.) -->
<a id="sdk-integration-guide"></a>
