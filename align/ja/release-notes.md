...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (Date '2025. 02. 27.' has no corresponding ko heading; ko jumps from 2025.03.25. to 2025.03.04.) -->
<a id="february-27-2025"></a>
## 2025. 02. 27. { #february-27-2025 }
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (Instance subheading under extra date 2025.02.27., no ko counterpart) -->
### Instance
* インスタンス説明変更機能を追加
* APIパスワードの変更時に既存のパスワードと同じパスワードに変更できないように制限
* ブロックストレージ及びスナップショットからインスタンス作成機能を追加

<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (Image subheading under extra date 2025.02.27., no ko counterpart) -->
### Image
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (Duplicate System Monitoring under 2023.10.31.; ko has only one System Monitoring (k64) at that date) -->
### System Monitoring
* バグ修正
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (Date '2023. 06. 13.' has no corresponding ko heading) -->
<a id="june-13-2023"></a>
## 2023. 06. 13. { #june-13-2023 }
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (System Monitoring subheading under extra date 2023.06.13., no ko counterpart) -->
### System Monitoring
...
### Image { #february-25-2020-system-monitoring }
...
### System Monitoring { #february-25-2020-1 }
* イベント状況ページの改善
...
<a id="december-17-2019-1"></a>
### Auto Scale { #december-17-2019-1 }
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (L5 '機能改善' subheading under System Monitoring (t176); ko has no such sub-subheading) -->
##### 機能改善
- ユーザー相互作用UIの改善
    - ユーザーグループ、監視グループ、監視設定などのモニタリング情報を照会/追加/修正/削除した時、ローディングバーが表示されるように修正
    - 相互作用中、不要なボタンは無効化されるように修正

<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (L5 'バグ修正' subheading under System Monitoring (t176); ko has no such sub-subheading) -->
##### バグ修正
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 ('機能改善' subheading under 2019.08.27.; ko has Image (k185) and System Monitoring (k186), no 機能改善) -->
### 機能改善
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 ('機能改善' subheading under 2019.06.25. (t186); ko k190 is Instance, not 機能改善) -->
### 機能改善
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 ('機能改善' subheading under 2019.05.28.; ko has Auto Scale and Image sub-sections, not this) -->
### 機能改善
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 ('기능 개선' subheading under 2019.05.14.; ko has Image (k195), not 기능 개선) -->
### 기능 개선
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 ('기능 개선' subheading under 2019.04.25.; ko has Auto Scale and Image, not 기능 개선) -->
### 기능 개선
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 ('기능 개선' subheading under 2019.03.26.; ko has Image (k200), not 기능 개선) -->
### 기능 개선
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 ('기능 개선' subheading under 2019.02.26.; ko has Image (k202), not 기능 개선) -->
### 기능 개선
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 ('기능 개선' subheading under t198 '29' (2019.01.29.); ko has Public API (k204), not 기능 개선) -->
### 기능 개선
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 ('기능 개선' subheading under 2018.12.27.; ko has Image (k206), not 기능 개선) -->
### 기능 개선
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 ('기능 개선' subheading under 2018.12.11.; ko has Image (k208), not 기능 개선) -->
### 기능 개선
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 ('기능 개선' subheading under 2018.11.13.; ko has Image (k210), not 기능 개선) -->
### 기능 개선
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 ('기능 개선' subheading under 2018.10.23.; ko has Image (k212), not 기능 개선) -->
### 기능 개선
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 ('기능 개선' subheading under 2018.09.20.; ko has Instance and Image, not 기능 개선) -->
### 기능 개선
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 ('기능 개선' subheading under 2018.08.09.; ko has Image (k217), not 기능 개선) -->
### 기능 개선
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 ('기능 개선' subheading under 2018.07.16.; ko has Image (k219), not 기능 개선) -->
### 기능 개선
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 ('버그 수정' subheading under t214 '29' (2018.05.29.); ko has Auto Scale/Instance/24/Instance subsections) -->
### 버그 수정
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 ('기능 추가' subheading under t214 '29' (2018.05.29.); no ko counterpart) -->
### 기능 추가
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 ('신규 상품 추가' subheading under t218 '22' (2018.03.22.); ko has Auto Scale (k226), semantically distinct) -->
### 신규 상품 추가
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 ('기능 개선' subheading under 2018.02.22.; ko has Instance and Image, not 기능 개선) -->
### 기능 개선
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 ('기능 추가' subheading under t222 '21' (2017.09.21.); ko has Public API and Instance) -->
### 기능 추가
* Public API 추가
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 ('버그 수정' subheading under t222 '21' (2017.09.21.); no ko counterpart) -->
### 버그 수정
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 ('버그 수정' subheading under t225 '20' (2017.07.20.); ko has Image (k234), not 버그 수정) -->
### 버그 수정
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 ('기능 추가' subheading under t227 '24' (2017.08.24.); ko has Instance (k236), not 기능 추가) -->
### 기능 추가
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 ('버그 수정' subheading under t227 '24' (2017.08.24.); no ko counterpart) -->
### 버그 수정
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 ('기능 추가' subheading under 2017.05.25.; ko has Instance and Image, not 기능 추가) -->
### 기능 추가

* 윈도우 이미지(Windows 2012 r2)가 추가됩니다.

<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 ('버그 수정' subheading under 2017.05.25.; no ko counterpart) -->
### 버그 수정
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 ('기능 개선' subheading under t233 '25' (2017.04.25.); ko has Instance (k241), not 기능 개선) -->
### 기능 개선
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 ('기능 개선' subheading under t235 '23' (2017.03.23.); ko has Instance (k243), not 기능 개선) -->
### 기능 개선
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 ('기능 개선/변경' subheading under t237 '19' (2017.01.19.); ko has Instance and Image) -->
### 기능 개선/변경
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 ('버그 수정' subheading under t237 '19' (2017.01.19.); no ko counterpart) -->
### 버그 수정
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 ('기능 개선/변경' subheading under t240 '22' (2016.12.22.); ko has Instance (k248), not 기능 개선/변경) -->
### 기능 개선/변경
