...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (Bug Fixes subheading under May 13, 2025 has no counterpart in ko — k17 (2025. 05. 13.) contains only one L4 child (기능 추가 및 개선, matched to t18)) -->
<a id="bug-fixes-4"></a>
