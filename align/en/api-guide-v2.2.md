...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (Request subheading under Upload Attached Files has no counterpart in ko, which lists only Response (k70) and upload example (k71)) -->
<a id="request-18"></a>
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (Example subheading under Send Templates (requiring no body updates) has no counterpart in ko; k95 carries no sub-headings) -->
#### Example
