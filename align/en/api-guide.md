...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 ('Request' subheading absent from ko k111 (첨부 파일 업로드); ko section goes directly to cURL) -->
<a id="request-24"></a>
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 ('Example' subheading absent from ko k144 (템플릿 발송 본문 수정 불필요); ko section has no child headings) -->
#### Example
