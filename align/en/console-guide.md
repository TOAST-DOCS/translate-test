...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (L4 '※ For reference' note inserted under t8; no corresponding L4 subheading exists under k8 in the KO source) -->
#### ※ For reference
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (L4 '※ For reference' note inserted under t11; no corresponding L4 subheading exists under k10 in the KO source) -->
#### ※ For reference
