...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (Request subheading under Upload Attached Files has no counterpart in ko source (ko k86 section has only cURL, Response, and example children)) -->
<a id="request-18"></a>
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (Example subheading under Send Templates (requiring no body updates) has no counterpart in ko source (ko k119 has no children)) -->
#### Example
