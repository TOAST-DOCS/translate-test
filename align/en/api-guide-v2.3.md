...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (Request subheading under Upload Attached Files has no ko counterpart; ko k86 section has only cURL, Response, and Example) -->
<a id="request-18"></a>
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (Example subheading under Send Templates (requiring no body updates) has no ko counterpart; ko k119 has no L4 children) -->
#### Example
