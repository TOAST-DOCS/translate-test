...
<a id="query-messages-by-result-update-criteria"></a>

## Query Messages by Result Update Criteria
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (No ko counterpart: k86 (Upload Attached Files) has no Request subheading; its subheadings are cURL, Response, and Example only) -->
<a id="request-18"></a>
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (No ko counterpart: k119 (Send Templates, no body updates) has no subheadings in ko) -->
#### Example
