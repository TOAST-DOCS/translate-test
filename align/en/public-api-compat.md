...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (Duplicate of 'Delete Port' (t25); ko has only one 포트 삭제하기 section. This partial duplicate heading has no distinct ko counterpart.) -->
<a id="delete-port"></a>
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (Child Request heading of the duplicate t23 'Delete a port' section; no distinct ko counterpart.) -->
