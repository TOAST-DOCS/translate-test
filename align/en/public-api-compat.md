...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (Duplicate of 'Delete Port' (t25); no separate ko counterpart for this partial heading — it lacks a Response and appears to be a malformed duplicate of k23/t25.) -->
<a id="delete-port"></a>
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (Request subheading under the duplicate 'Delete a port' (t23) which has no ko counterpart.) -->
