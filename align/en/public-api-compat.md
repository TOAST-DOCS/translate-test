...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (Duplicate/partial heading for 'Delete Port' (포트 삭제하기); ko has only one such section, already matched to t25. t23 is an extra unmatched heading covering the same concept with only a Request child (t24) and no Response.) -->
<a id="delete-port"></a>
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (Child of extra heading t23; no ko counterpart since k23 is matched to t25.) -->
