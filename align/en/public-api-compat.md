...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (Duplicate of 'Delete Port' (t25); t23 is a partial duplicate heading 'Delete a port' with only a Request subheading and no ko counterpart distinct from k23) -->
<a id="delete-port"></a>
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (Child of extra heading t23; no ko counterpart) -->
